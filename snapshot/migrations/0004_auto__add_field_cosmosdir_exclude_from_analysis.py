...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CosmosDir.exclude_from_analysis'
        db.add_column(u'snapshot_cosmosdir', 'exclude_from_analysis',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CosmosDir.exclude_from_analysis'
        db.delete_column(u'snapshot_cosmosdir', 'exclude_from_analysis')
