...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Suggestion.cosmosdir'
        db.alter_column(u'suggestion_suggestion', 'cosmosdir_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['snapshot.CosmosDirTree']))

    def backwards(self, orm):

        # Changing field 'Suggestion.cosmosdir'
        db.alter_column(u'suggestion_suggestion', 'cosmosdir_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['snapshot.CosmosDir']))
    ...
    models = {
        ...
        u'suggestion.suggestion': {
            ...
            'cosmosdir': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'suggestions'", 'to': u"orm['snapshot.CosmosDirTree']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
