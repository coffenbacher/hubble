...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Suggestion.notes'
        db.alter_column(u'suggestion_suggestion', 'notes', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Suggestion.notes'
        raise RuntimeError("Cannot reverse this migration. 'Suggestion.notes' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Suggestion.notes'
        db.alter_column(u'suggestion_suggestion', 'notes', self.gf('django.db.models.fields.TextField')())
